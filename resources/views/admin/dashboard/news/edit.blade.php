                        ...
                        <div class="card-body">
                            ...
                            <form action="{{ route('admin.news.update', $news->id) }}" method="post"
                                                            ...
                                                            <div class="row mb-3">
                                                                ...
                                                                <div class="col-sm-10">
                                                                    <input class="form-control" type="text"
                                                                        name="{{ $locale }}[title]"
                                                                        value="{{ @$news->trans->where('locale', $locale)->first()->title }}"
                                                                        id="title{{ $key }}">
                                                                </div>
                                                            ...
                                                            <div class="row mb-3 slug-section">
                                                                ...
                                                                <div class="col-sm-10">
                                                                    <input type="text" id="slug{{ $key }}"
                                                                        name="{{ $locale }}[slug]"
                                                                        value="{{ @$news->trans->where('locale', $locale)->first()->slug }}"
                                                            ...
                                                            <div class="row mb-3">
                                                                ...
                                                                <div class="col-sm-10">
                                                                    <input class="form-control" type="text"
                                                                        ...
                                                                        value="{{ @$news->trans->where('locale', $locale)->first()->meta_title }}"
                                                                        id="title{{ $key }}">
                                                                </div>
                                ...
                                @if ($news->images->count() > 0)
                                    <div class="accordion mt-4 mb-4" id="currentGalleryAccordion">
                                        <div class="accordion-item border rounded">
                                            <h2 class="accordion-header">
                                                <button class="accordion-button fw-medium" type="button"
                                                    data-bs-toggle="collapse" data-bs-target="#currentGallery"
                                                    aria-expanded="true">
                                                    @lang('admin.current_gallerys') ({{ $news->images->count() }})
                                                </button>
                                            </h2>
                                            <div id="currentGallery" class="accordion-collapse collapse show">
                                                <div class="accordion-body">
                                                    <div class="row">
                                                            ...
                                                            <div class="col-md-3 col-sm-4 mb-3">
                                                                <div class="card h-100">
                                                                    ...
                                                                    <div class="card-body p-2 text-center">
                                                                        <small class="text-muted">@lang('admin.sort'):
                                                                            {{ $image->sort }}</small>
                                                                        <a href="{{ route('admin.news.gallery.destroy', $image->id) }}"
                                                                            class="btn btn-danger btn-sm d-block mt-2"
                                ...
                                {{-- إضافة صور جديدة --}}
                                <div class="accordion mt-4 mb-4" id="newGalleryAccordion">
                                    <div class="accordion-item border rounded">
                                        <h2 class="accordion-header">
                                            <button class="accordion-button fw-medium collapsed" type="button"
                                                data-bs-toggle="collapse" data-bs-target="#newGallery"
                                                aria-expanded="false">
                                                @lang('admin.add_new_images')
                                            </button>
                                        </h2>
                                        <div id="newGallery" class="accordion-collapse collapse">
                                            <div class="accordion-body">
                                                <div id="gallery_images"></div>
                                                <button type="button" class="btn btn-success form-control mt-3"
                                                    id="add_gallery_image">
                                                    <i class="fa fa-plus"></i> @lang('admin.add_image')
                                                </button>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div class="col-12">
                                                ...
                                                <div class="col-sm-10">
                                                    <input class="form-check form-switch" name="feature" type="checkbox"
                                                        ...
                                                        {{ @$news->feature == 1 ? 'checked' : '' }} value="1">
        ...
        $('#gallery_images').append(`
            <div class="gallery-item border rounded p-3 mb-3">
                <div class="row align-items-end">
                    ...
                    <div class="col-md-3">
                        <button type="button" class="btn btn-danger w-100 remove-gallery-item">
