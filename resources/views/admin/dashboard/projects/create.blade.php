                                            ...
                                            <div id="collapseOneSlugs" class="accordion-collapse collapse  mt-3"
                                                ...
                                                <div class="accordion-body">
                                                    ...
                                                    @foreach ($languages as $key => $locale)
                                                        ...
                                                        <div class="row mb-3">
                                                            <label for="example-text-input"
                                                                class="col-sm-2 col-form-label">{{ trans('products.meta_description') . trans('lang.' . Locale::getDisplayName($locale)) }}</label>
                                                            <div class="col-sm-10">

                                                                <textarea class="form-control" id="meta_description{{ $key }}" name="{{ $locale }}[meta_description]">
                                                        {{ old($locale . '.meta_description') }}
                                                        </textarea>
                                                    ...
                                                    <div class="col-12">
                                                        ...
                                                        <div class="col-sm-10">
                                                            <input class="form-check form-switch" name="feature"
                                                                type="checkbox" id="switch1" switch="success" checked
                                                                value="1">
