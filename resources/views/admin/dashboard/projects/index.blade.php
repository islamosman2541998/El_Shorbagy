                        ...
                        <form action="{{ route('admin.projects.index') }}" method="get">
                            <div class="row mb-3">
                                ...
                                <div class="search-input col-md-2">
                                    ...
                                    <a class="btn btn-success btn-sm" href="{{ route('admin.projects.index') }}"><i
                                    ...
                                    @foreach ($items as $key => $item)
                                        <tr>
                                            ...
                                            <td> <a href="{{ asset($item->image) }}" target="_blank"><img
                                                        src="{{ asset($item->image) }}" alt="" width="50"></a>
                                            </td>
                                            ...
                                            <td>
                                                <div class="d-flex justify-content-center">
                                                    @if ($item->status == 1)
                                                        <a href="{{ route('admin.projects.update-status', $item->id) }}"
                                                    ...
                                                    @endif
                                                    @if ($item->feature == 1)
                                                        <a href="{{ route('admin.projects.update-featured', $item->id) }}"
