            ...
            <div class="row gx-5 footerdiv">
                    ...
                    <div class="row gx-5">
                        ...
                        <div class="col-lg-4 col-md-12 pt-0 pt-lg-5 mb-3" data-animate="animate__backInLeft">
                            ...
                            <div class="d-flex mt-4">
                                <a class="btn btn-secondary btn-square rounded-circle me-2" href="{{ $settings->getItem('twitter') }}"><i
                                        class="fab fa-twitter"></i></a>
                                <a class="btn btn-secondary btn-square rounded-circle me-2" href="{{ $settings->getItem('facebook') }}"><i
                                        class="fab fa-facebook-f"></i></a>
                                <a class="btn btn-secondary btn-square rounded-circle me-2" href="{{ $settings->getItem('linkedin') }}"><i
                                        class="fab fa-linkedin-in"></i></a>
                                <a class="btn btn-secondary btn-square rounded-circle me-2" href="{{ $settings->getItem('instagram') }}"><i
                ...
                <div class="col-lg-4 col-md-6 mt-lg-n5" data-animate="animate__backInLeft">
                    <div
                        ...
                        <a href="{{ route('site.about-us') }}" class="btn btn-primary py-md-3 px-md-5 me-3">@lang('admin.about-us')</a>
